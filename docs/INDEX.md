...
| `ROADMAP.md`                    | Sole milestone order and extension-GA gate                               | CURRENT | Product owner                          | M1-M12            | `docs/milestones.md`, `docs/future-platform-roadmap.md` | Changelog and milestone reports |
...
- Milestone specifications and evidence: `docs/milestones/` after Milestone 1.5 reorganization.
- Historical evidence: `docs/archive/` after Milestone 1.5 reorganization.
