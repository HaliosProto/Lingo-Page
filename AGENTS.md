...
This file contains permanent repository instructions for Codex and other coding agents. Apply it to every task in this repository. More-specific instructions in a nested `AGENTS.md` override this file only for files in that subtree. Direct user instructions override repository defaults.
